...
#def eff(csvname, size, freq, tau_z, axi='az'):
def eff(csvname, size, tau_z, axi='az'):
    ...
    """
    import pandas as pd
    colnames = ['time', 'az', 'azoff', 'azerr', 'el', 'eloff', 'elerr', 'T_atm', 'T_amb', 'PM_R', 'PM_L']
    ...
    #cols: 'az', 'azoff', 'azerr', 'el', 'eloff', 'elerr', 'freq', 'T_atm', 'T_amb', 'PM_R', 'PM_L'
    ax = {'az':0, 'el':3}
    ...
    if axi == 'az':
        ...
        #print('Hot Amp.     [RHC]:', ave_hot_amp_R, '[mW]')
        #print('Sky Amp.     [RHC]:', V_sky_R, '[mW]')
        ...
        #print('Hot Amp.     [LHC]:', ave_hot_amp_L, '[mW]')
        #print('Sky Amp.     [LHC]:', V_sky_L, '[mW]')
    ...
    ### Brightness Temperature for Venus
    if ((freq > 60.0) and (freq < 118.0)):
        T_sbt = 367.1  ### [K]  <== Brightness temperature at 90 GHz.
                       ###          Ulich 1981, AJ, 86, 1619
        eta_l = 0.945
    elif ((freq > 118.0) and (freq < 200.0)):
        T_sbt = 294    ### [K]  <== Brightness temperature at 150 GHz.
                       ###          Ulich 1981, AJ, 86, 1619
    elif ((freq > 200.0) and (freq < 300)):
        T_sbt = 291    ### [K]  <== Brightness temperature at 214 GHz.
    ...
    #J_amb  = 1.0 / (np.exp(0.048 * freq / (T_amb + 273.15)) - 1.0)
    J_atm  = 1.0 / (np.exp(0.048 * freq / (T_atm)) - 1.0)
    #J_atm  = 1.0 / (np.exp(0.048 * freq / (T_atm + 273.15)) - 1.0)
    ...
    #print('Source Temp. [RHC] =', T_source_R, '[K]')
    #print('Source Temp. [LHC] =', T_source_L, '[K]')
...
### For measurement data "contData_180306_154456_Rx86_Venus+hotload"
###   & "contData_180306_155055_Rx86_Venus+hotload"
#T_hot = 283.15  ### [K]
#T_atm = -19.7   ### [C]
#T_amb =   9.5   ### [C]
#size = 10.3   ### [arcsec]
...
### For measurement data "contData_180308_175703_Rx86_Venus+hotload"
#T_amb =   9.66  ### [C]
#T_hot = T_amb + 273.15  ### [K]
#T_atm = -29.5   ### [C]
#size = 10.1   ### [arcsec]
#freq = 86.6   ### [GHz]
#tau_z = 0.08  ### Zenith opacity

### For measurement data "contData_180317_183430_Rx230_Venus+hotload"
#T_hot = 279.36  ### [K]
#T_atm = -28.0   ### [C]
#T_amb =   9.68  ### [C]
#size =  10.3   ### [arcsec]
#freq = 230.5   ### [GHz]
#tau_z =  0.26  ### Zenith opacity

### For measurement data "contData_180329_180415_Rx86_Venus+hotload"
#T_hot = 281.06  ### [K]
#T_atm = -23.7   ### [C]
#T_amb =  11.24  ### [C]
#size = 10.5   ### [arcsec]
...
### For measurement data "EfficiencyData_20200226_210837_venus"
#size =  18.3   ### [arcsec]
#freq = 230.5   ### [GHz]
#tau_z =  0.16  ### Zenith opacity

### For measurement data "EfficiencyData_20200306_hhmmss_Rx230_venus"
size =  19.7   ### [arcsec]
#tau_z =  0.12  ### Zenith opacity : 183125,184709
tau_z =  0.13  ### Zenith opacity : 191401,192242

#eff(csvfile, T_hot, T_amb, T_atm, size, freq, tau_z)
#eff(csvfile, size, freq, tau_z)
